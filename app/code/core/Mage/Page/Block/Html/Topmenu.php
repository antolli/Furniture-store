    ...
    protected function _getHtml(Varien_Data_Tree_Node $menuTree, $childrenWrapClass)
    {
        ...
        foreach ($children as $child) {
            ...
            if ($child->hasChildren()) {
                ...
                $categoria = Mage::getModel("catalog/category")->load($id);
                $html .= '<div class="box-subcat">';
                $html .= '<ul class="level' . $childLevel . '">';
                $html .= $this->_getHtml($child, $childrenWrapClass);
                $html .= '</ul>';
                $html .= '<img class="imagem"  src="'.Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_MEDIA).'catalog/category/'.$categoria->getData('thumbnail').'" style="z-index:999999; ">';
                $html .= '</div>';
